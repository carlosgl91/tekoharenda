...
Datos procesados:
> *Giménez, C. (2026). Capa raster binaria de áreas urbanas a partir de datos del INE 2022 e OSM 2025 (Versión 1.0)[Dataset de Google Earth Engine]. Tekoharenda: Catálogo Nacional de Datos Espaciales. https://carlosgl91.github.io/tekoharenda/*
