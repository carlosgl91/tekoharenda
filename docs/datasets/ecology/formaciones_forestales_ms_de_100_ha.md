...
**Descripción:** Esta capa consiste en los parches de formaciones forestales correspondientes a “Leñosas cerradas” y “leñosas inundables” de la capa de MapBiomas Paraguay colección 2, cuyo tamaño es mayor a 100 ha.
...
```javascript
var dataset = ee.Image("projects/arapy-487423/assets/forest_2023_over_100ha_MapBiomasPyCol2"); 
